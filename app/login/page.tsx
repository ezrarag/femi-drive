  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        >
          <source
            src="https://firebasestorage.googleapis.com/v0/b/readyaimgo-clients-temp.firebasestorage.app/o/femileasing%2Fadmin-login%2F8630304-uhd_3840_2160_25fps.mp4?alt=media&token=80b7e849-784d-4831-8c32-45cbe6728b31"
            type="video/mp4"
          />
          ...
          >
            <div className="mb-6 flex flex-col items-center">
              ...
              <p className="text-white/80 text-center text-sm">
                Sign in with your Google account to access your dashboard and manage your bookings.
              </p>
